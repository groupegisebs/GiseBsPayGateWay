...
public interface IStripeService
{
    ...
    Task<(string SessionId, string? Url, string? ClientSecret)> CreateCheckoutSessionAsync(
        Entities.PaymentTransaction payment,
        Entities.Customer customer,
        Entities.PricingPlan plan,
        string successUrl,
        string cancelUrl,
        int? trialDays = null,
        bool embedded = false,
        DTOs.BillingAddressDto? billingAddress = null,
        DTOs.CustomerUpdateDto? customerUpdate = null,
    ...
    /// </summary>
    Task<Stripe.Subscription> RecreateSubscriptionAsync(
        Entities.Customer customer,
